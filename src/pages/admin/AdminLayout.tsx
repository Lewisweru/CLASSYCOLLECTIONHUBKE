...
import { useAdminAuth } from '../../hooks/useAdminAuth'; // Stays the same
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
    const { logout } = useAdminAuth(); // Use the updated hook
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <aside className="w-64 bg-gray-800 text-gray-200 flex flex-col flex-shrink-0">
                ...
                <nav className="flex-grow p-4 space-y-1">
                    ...
                    <NavLink to="/admin/categories" className={({ isActive }) => isActive ? activeClassName : inactiveClassName} >
