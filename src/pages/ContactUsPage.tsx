...
import { Phone, Mail, MapPin, Send, Loader2, Facebook, Instagram } from 'lucide-react';
...
const socialLinks = [
  ...
  },
  {
    ...
    icon: SiTiktok,
    colorClass: 'text-neutral-900', // Updated for visibility
              ...
              <div className="flex space-x-4">
                {socialLinks.map((link) => {
                  ...
                  return (
                    ...
                    >
                      <Icon className={`h-6 w-6 ${link.colorClass} ${link.hoverColorClass} transition-colors duration-200`} />
                    </a>
                  );
                })}
              </div>
